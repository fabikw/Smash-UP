...
FACTIONS = {'Aliens': ('Alien', 'Aliens', Expansion.base),
            ...
            'Robots': ('Robot', 'Robots', Expansion.base),
            'Tricksters': ('Trickster', 'Tricksters', Expansion.base),
            'Wizards': ('Wizard', 'Wizards', Expansion.base),
            ...
            'Time Travelers': ('Time Traveler', 'Time Travelers', Expansion.SFDF),
            'Cyborg Apes': ('Cyborg Ape', 'Cyborg Apes', Expansion.SFDF),
            'Super Spies': ('Super Spy', 'Super Spies', Expansion.SFDF),
            'Shapeshifters': ('Shapeshifter', 'Shapeshifters', Expansion.SFDF),
